...
@file: electsysApi/manip/check_selected.py
@time: 2019/1/11
'''
...
from electsysApi.interface.interface import ElectCourse, CourseDetail
from electsysApi.shared.exception import RequestError, ParseError
